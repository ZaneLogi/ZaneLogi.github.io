...
/*
 * Vendored from https://github.com/alexanderk23/ayumi-js (port of Peter
 * Sovietov's Ayumi C core). Highly precise AY-3-8910 / YM2149 emulation.
 * License: MIT (see the upstream repository).
 *
 * Local adaptation for this repo (ES6 modules, no build step):
 *   - line ~48: `Ayumi = function()` -> `const Ayumi = function()`
 *     (an implicit global is a ReferenceError under module strict mode)
 *   - appended `export { Ayumi };`
 * Nothing else is changed; the emulation core is byte-for-byte upstream.
 */
