...
- **Naming:** the spill loot list + the "You put *X* in *Y*." insert message need item names, so a single
  ...
  tile registry.
- **Verification:** `tests/test_container.html` 28/28 (pure logic) + in-game on real U6 data (closed chest
