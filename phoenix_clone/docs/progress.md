...
Steps 1-13 are ✅ done; step 14 (splash) is 🚧 in progress
(sub-steps A-E landed locally, F-I remaining — see the step row above).
Once 14 closes, step 15 will add the attract-mode demo, then step 16
