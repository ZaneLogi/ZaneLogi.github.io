...
| **12.4** | Stage B base combat: wire JT4 case B to call existing `stageAlienCombat` (no mothership hook yet). Aliens swoop + fire normally against the mothership backdrop. Player can hit aliens but not the belt or mothership. | Low | Stage B plays like stages 1/3 but with a mothership graphic on screen. |
