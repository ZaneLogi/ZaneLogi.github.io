// Alien subsystem — L0532 init, L0834 fade-in, L2000 combat, L0D1C/L0D70
// movement + animation, L3000 behaviour, L0DF0/L0F00 collisions,
// L0C40/L2560 enemy bullets + fire, L21BA stage-clear.
//
// Spread into the main `states` object in states.js the same way
// states_mothership.js / states_intro.js / states_player.js /
// states_explosion.js do, so all `this.xxx()` cross-calls continue to
// resolve correctly at runtime.
//
// Local helpers getPathByte / alienBox / s8 are alien-only and live here.
// aabbHit is duplicated here AND kept in states.js because bird methods
// still in states.js also use it (until states_bird.js is extracted).
...
// --- Local helpers (moved from states.js) ---
...
// Duplicated here AND kept in states.js because bird methods still in
// states.js also use it (until states_bird.js is extracted).
