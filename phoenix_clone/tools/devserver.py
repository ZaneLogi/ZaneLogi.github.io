#!/usr/bin/env python3
# Tiny no-cache dev server for the phoenix_clone JS port.
#
...
# fresh content. Same CLI as the stock server:
#   python tools/devserver.py 127.0.0.1 8081 phoenix_clone
#
# Wired up via .claude/launch.json so `preview_start` picks it up.
...
class NoCacheHandler(SimpleHTTPRequestHandler):
    ...
    def send_response(self, code, message=None):
        # Suppress Last-Modified emission downstream.
